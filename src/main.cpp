...
int main(int argc, char **argv) {
    ...
    try {
        cli.command("printArguments", "Displays the passed arguments", "$ printArguments file1.txt file2.txt\n>>> Arguments:\n file1.txt\n    file2.txt", func, "String[-1]")     // Добавляем команду printArguments
           .command("printTwoArguments", "Displays the passed arguments", func, "StringArray[2]")                                                                            // Добавляем команду printTwoArguments
           ...
           .command("printFlagsAndArguments", "Displays the passed flags and arguments", "$ printFlagsAndArguments file1.txt --dir value file2.txt\n>>> Flags:\n    flag -> value\n Arguments:\n    file1.txt\n    file2.txt",
                         ...
                         }, func4, "StringArray[-1]")                                                                                                         // Добавляем команду printFlagsAndArguments
